Feature: Adding Value Journeys
    ...
    Scenario: Successfully apply for a grant on the Project Items-only journey
        ...
        Given there is no application state or submissions stored for SBI "115371673" and grant "adding-value"
        ...
        # GAS
        Then the reference number along with SBI "115371673" and CRN "1100946179" should be submitted to GAS
